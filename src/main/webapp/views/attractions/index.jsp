...
<body> 
 ...
 <main class="container"> 
  ...
  <c:if test="${user.isAdmin()}"> 
   <div class="mb-3"> 
    <a href="/TierraMediaTours1/attractions/create.do" class="btn btn-primary" 
    ...
    <c:forEach items="${attractions}" var="attraction"> 
     <tr> 
      ...
      <td><c:if test="${user.admin}"> 
        <a href="/TierraMediaTours1/attractions/edit.do?id=${attraction.id}" 
         class="btn btn-light rounded-0" role="button"><i 
         class="bi bi-pencil-fill"></i></a> 
        <a href="/TierraMediaTours1/attractions/delete.do?id=${attraction.id}" 
        ...
        <c:when 
         ...
         <a href="/TierraMediaTours1/attractions/buy.do?id=${attraction.id}" 
