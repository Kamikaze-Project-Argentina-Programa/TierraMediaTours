...
public class PromocionesDAO {
	...
	public static List<LeePromociones> findAll() throws SQLException {

		List<LeePromociones> losLeePromos = new ArrayList<LeePromociones>();

		Connection connection = ConnectionProvider.getConnection();

		String query = "SELECT ta.tipo, p.desc_prom, a.nombre, a.cupo, ab.nombre, ab.cupo, ac.nombre, ac.cupo\r\n"
				+ "				FROM promociones p INNER JOIN tipo_atracciones ta ON p.tipo_pack = ta.id\r\n"
		...
		while (resultSet.next()) {
			...
			losLeePromos.add(leePromociones);
		}
