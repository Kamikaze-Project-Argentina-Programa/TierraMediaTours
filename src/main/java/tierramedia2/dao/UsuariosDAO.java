...
public class UsuariosDAO {
	...
	public LeeUsuarios findById(Integer id) throws SQLException {
		...
		String query = "SELECT u.id, u.nombre, u.saldo, u.tiempo_dispo, a.tipo FROM usuarios u LEFT OUTER JOIN tipo_atracciones a ON u.id_tipo_atraccion = a.id WHERE u.id=?";
